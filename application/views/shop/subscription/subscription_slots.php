                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo base_url('shop-subscription-data'); ?>">Subscription Master</a></li>
                                                    ...
                                                    <div class="modal-dialog  modal-lg">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form class="needs-validation" action="<?php echo base_url('shop-subscription-data/add_subscription_slot'); ?>" method="post">  
                                                                <div class="row">   
                                                                    <div class="col-6">
                                            ...
                                            <table class="jsgrid-table">
                                                ...
                                                <tr class="jsgrid-filter-row">
                                                    ...
                                                    <a  data-toggle="modal" href="#" data-target="#edit-subscription-slot<?php echo $value->id; ?>" ><i class="fa fa-edit"></i></a>
                                                        <a href="<?php echo base_url('shop-subscription-data/delete_subscription_slot/' . $value->id); ?>" onclick="return confirm('Do you want to delete this?')"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr> 
                                                <div id="edit-subscription-slot<?php echo $value->id; ?>" class="modal  bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                    <div class="modal-dialog  modal-lg">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form class="needs-validation" action="<?php echo base_url('shop-subscription-data/edit_subscription_slot/'.$value->id); ?>" method="post">
...
<script>
    ...
    {
        $.ajax({
        url: "<?php echo base_url('shop-subscription-data/change_slot_status'); ?>",
        method: "POST",
        data: {
            id:id
        },
   ...
   $('#delete_all').click(function(){
        ...
        var table = 'subscriptions_slots';
            ...
            $.ajax({
                url:"<?php echo base_url(); ?>shop-subscription-data/multiple_delete",
                method:"POST",
