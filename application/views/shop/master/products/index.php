...
function getid(proid) {
    $("#pro_content"+proid).load("<?php echo base_url('master_shop/view_product_images/') ?>"+proid)
}
// $(document).ready(function(){
// $("#view-product-images").load("<?php echo base_url('master_shop/view_product_images'); ?>")
// })
