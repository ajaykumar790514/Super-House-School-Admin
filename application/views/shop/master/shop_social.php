                                                    ...
                                                    <div class="modal-dialog  modal-lg">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form class="needs-validation" action="<?php echo base_url('shop-master-data/add_shop_social'); ?>" method="post">
                                                                <div class="row">
                                                                    <div class="col-6">
                                            ...
                                            <table class="jsgrid-table">
                                                ...
                                                <tr class="jsgrid-filter-row">
                                                    ...
                                                    <a  data-toggle="modal" href="#" data-target="#edit-shop-social<?php echo $value->id; ?>" ><i class="fa fa-edit"></i></a>
                                                        <a href="<?php echo base_url('shop-master-data/delete_shop_social/' . $value->id); ?>" onclick="return confirm('Do you want to delete this?')"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr> 
                                                <div id="edit-shop-social<?php echo $value->id; ?>" class="modal  bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                    <div class="modal-dialog  modal-lg">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="<?php echo base_url('shop-master-data/edit_shop_social/'.$value->id); ?>" method="post">
                                                                    <div class="row">
                                                                        <div class="col-6">
                                                                            <div class="form-group">
                                                                                <label class="control-label">Icon</label>
...
<script>
    ...
    {
        $.ajax({
        url: "<?php echo base_url('shop-master-data/change_social_status'); ?>",
        method: "POST",
        data: {
            id:id
        },
