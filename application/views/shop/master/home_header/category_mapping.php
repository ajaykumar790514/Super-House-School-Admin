                                        ...
                                        <div id="grid_table">
                                            <table class="jsgrid-table">
                                                ...
                                                <tr class="jsgrid-filter-row">
                                                    ...
                                                    <td class="jsgrid-cell jsgrid-align-center">
                                                        <a href="<?php echo base_url('shop-master-data/delete_cat_header_mapping/' . $value->id); ?>" onclick="return confirm('Do you want to delete this?')"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                                <?php } ?>  
                                                </table>
...
<script type="text/javascript">
   ...
   {
    $.ajax({
        url: "<?php echo base_url('shop-master-data/add_cat_mapping'); ?>",
        method: "POST",
        data: {
            headerid:headerid
        },
...
<script type="text/javascript">
   function map_category(cid)
   {
    ...
    $.ajax({
        url: "<?php echo base_url('shop-master-data/map_category'); ?>",
        method: "POST",
        data: {
            cid:cid,
            headerid:headerid
...
<script type="text/javascript">
   function remove_map_category(cid)
   {
    var headerid = $('#headerid').val();
    $.ajax({
        url: "<?php echo base_url('shop-master-data/remove_map_category'); ?>",
        method: "POST",
        data: {
            cid:cid,
            headerid:headerid
