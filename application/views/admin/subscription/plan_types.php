                                                    ...
                                                    <div class="modal-dialog  modal-lg">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form class="needs-validation" action="<?php echo base_url('subscription-data/add_plan_type'); ?>" method="post" enctype="multipart/form-data">
                                                                    <div class="row">
                                                                        <div class="col-12">
                                            ...
                                            <table class="jsgrid-table">
                                                ...
                                                <tr class="jsgrid-filter-row">
                                                    ...
                                                    <a  data-toggle="modal" href="#" data-target="#edit-plan-type<?php echo $value->id; ?>" ><i class="fa fa-edit"></i></a>
                                                        <a href="<?php echo base_url('subscription-data/delete_plan_type/' . $value->id); ?>" onclick="return confirm('Do you want to delete this?')"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr> 
                                                <div id="edit-plan-type<?php echo $value->id; ?>" class="modal  bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                    <div class="modal-dialog  modal-lg">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="<?php echo base_url('subscription-data/edit_plan_type/'.$value->id); ?>" method="post">
                                                                    <div class="row">
                                                                        <div class="col-12">
                                                                            <div class="form-group">
                                                                                <label class="control-label">Plan type</label>
...
<script>
    ...
    {
        $.ajax({
        url: "<?php echo base_url('subscription-data/change_plan_type_status'); ?>",
        method: "POST",
        data: {
            id:id
        },
