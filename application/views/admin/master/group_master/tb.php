    ...
    <div id="grid_table">
        <table class="jsgrid-table">
            <tr class="jsgrid-header-row">
                ...
                <th class="jsgrid-header-cell jsgrid-align-center">Business Name</th>
...
<script>
    ...
    {
        $.ajax({
        url: "<?php echo base_url('master-data/change_group_master'); ?>",
        method: "POST",
        data: {
            id:id
        },
...
<script>
    function delete_vendor(vid){
        ...
        {
            $('#tb').load("<?php echo base_url('group-master/delete/')?>"+vid );
        }
    }
                   //multiple delete
