    ...
    <div id="grid_table">
        <table class="jsgrid-table">
            <tr class="jsgrid-header-row">
                ...
                <th class="jsgrid-header-cell jsgrid-align-center">Subject Name</th>
...
<script>
    ...
    {
        $.ajax({
        url: "<?php echo base_url('master-data/change_subject_master'); ?>",
        method: "POST",
        data: {
            id:id
        },
...
<script>
    function delete_vendor(vid){
        ...
        {
            $('#tb').load("<?php echo base_url('subject-master/delete/')?>"+vid );
            loadtb();
        }
    }
                   //multiple delete
