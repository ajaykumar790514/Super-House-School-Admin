    ...
    <div id="grid_table">
        <table class="jsgrid-table">
            <tr class="jsgrid-header-row">
                ...
                <th class="jsgrid-header-cell jsgrid-align-center">Min </th>
                <th class="jsgrid-header-cell jsgrid-align-center">Max </th>
            ...
            <tr class="jsgrid-filter-row">
                ...
                <td class="jsgrid-cell jsgrid-align-center"><?php echo $value->min;?></td>
                <td class="jsgrid-cell jsgrid-align-center"><?php echo $value->max;?></td>
                ...
                <td class="jsgrid-cell jsgrid-align-center">
                    ...
                    <a href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Update Delivery Charges ( <?=$value->min?> - <?=$value->max?> )" data-url="<?=$update_url?><?=$value->id?>" >
...
<script>
    ...
    {
        $.ajax({
        url: "<?php echo base_url('master-data/change_delivery_charges'); ?>",
        method: "POST",
        data: {
            id:id
        },
...
<script>
    function delete_vendor(vid){
        ...
        {
            $('#tb').load("<?php echo base_url('delivery-charges/delete/')?>"+vid );
            loadtb();
        }
    }
                   //multiple delete
