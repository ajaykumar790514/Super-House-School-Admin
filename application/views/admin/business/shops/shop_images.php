...
<script>
    function add_shop_img(sid){
        ...
        $.ajax({
            url: '<?php echo base_url('business-store/shops/add_image'); ?>', 
            type: 'post',
            data: form_data,
            contentType: false,
            processData: false,
        ...
        $('#showModal .modal-body').load("<?php echo base_url('business-store/shops/shop-images/')?>"+<?=$sid ?>);
...
<script>
    function deleteimage(imageid){
        ...
        {
            $('#showModal .modal-body').load("<?php echo base_url('business-store/shops/delete_image/')?>"+<?=$sid ?>+"/"+imageid );
...
<script>
    function makecover(imageid){
        ...
        {
            $('#showModal .modal-body').load("<?php echo base_url('business-store/shops/make_cover/')?>"+<?=$sid ?>+"/"+imageid );
...
<script>
    function update_shop_seq(imageid){
        ...
        var seq = $('#seq'+imageid).val();
            $('#showModal .modal-body').load("<?php echo base_url('business-store/shops/update_shop_seq/')?>"+<?=$sid ?>+"/"+imageid+"/"+seq );
