...
function validate_date() {
    ...
    if (!start_date && expiry_date) {
        msg = "Please select the start date before selecting the expiry date";
        $('#msg1').css('color', 'red').html(msg);
    }else{
        $('#msg1').css('color', 'red').html("");
    }
    ...
    if (start_date && expiry_date) {
        if (start_date >= expiry_date) {
            ...
            $('#msg').html(""); // Clear error message if dates are valid
        }
    }
}
